# Build Phase 2-B — AI-I: Scheduler and Recurring Automation

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **AI-I — Scheduler and Recurring Automation**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage AI-H is complete.
