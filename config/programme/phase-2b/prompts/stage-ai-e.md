# Build Phase 2-B — AI-E: Client Agent Runtime

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **AI-E — Client Agent Runtime**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage AI-D is complete.
