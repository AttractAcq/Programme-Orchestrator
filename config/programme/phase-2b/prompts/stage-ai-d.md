# Build Phase 2-B — AI-D: Durable Workflow Orchestrator

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **AI-D — Durable Workflow Orchestrator**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage AI-C is complete.
