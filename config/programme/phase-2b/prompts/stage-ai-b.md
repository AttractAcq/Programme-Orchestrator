# Build Phase 2-B — AI-B: Client Knowledge Fabric

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **AI-B — Client Knowledge Fabric**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage AI-A is complete.
