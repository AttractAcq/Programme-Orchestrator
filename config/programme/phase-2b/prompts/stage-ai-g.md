# Build Phase 2-B — AI-G: Global Admin AI Console

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **AI-G — Global Admin AI Console**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage AI-F is complete.
