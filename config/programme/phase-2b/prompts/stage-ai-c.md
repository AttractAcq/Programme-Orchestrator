# Build Phase 2-B — AI-C: Canonical Command Registry

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **AI-C — Canonical Command Registry**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage AI-B is complete.
