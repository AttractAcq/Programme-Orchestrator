# Build Phase 1-B — 1B-B: Facebook Page Destinations and Authorisation

You are operating inside Attract Acquisition's `AttractAcq/Cockpit` repository and are responsible for implementing **1B-B — Facebook Page Destinations and Authorisation**. This is a full implementation task, not a speculative report.
...
- Dependency position: Stage 1B-A is complete.
