...
- Stage `auto_push` is disabled. Human approval may push only the configured integration branch; the orchestrator never pushes or merges a stage branch to `main`.
